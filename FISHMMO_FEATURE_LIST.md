...
41. **Guild System** — Creation, membership, invitations (TTL-expiring and identity-bound), periodic update pump, character connect/disconnect tracking, MOTD and notice, an activity log (`guild_log`), member notes, applications, and **per-rank permission flags**.
