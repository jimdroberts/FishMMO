...
namespace FishNet.Managing.Client
{
    ...
    public sealed partial class ClientManager : MonoBehaviour
    {
        ...
        private void ParseAuthenticated(PooledReader reader)
        {
            ...
            if (networkManager.IsNode || !networkManager.IsServer)
            {
            ...
            else
            {
                ...
                {
					// This is intended behaviour for the SceneServer. Ignore the Error logging and just create the connection.
