...
namespace FishMMO.Database.Npgsql.Services
{
	...
	public sealed class CharacterAchievementService : BaseService<CharacterAchievementEntity>, ICharacterAchievementService
	{
		...
		/// </summary>
		private static readonly Func<NpgsqlDbContext, long, IAsyncEnumerable<CharacterAchievementEntity>> getAchievementsQuery =
		...
		public async Task<DatabaseResult<IReadOnlyList<CharacterAchievementData>>> FetchAsync(long characterId, CancellationToken cancellationToken = default)
		{
			...
			{
				var entities = await getAchievementsQuery(dbContext, characterId).MaterializeAsync(cancellationToken).ConfigureAwait(false);
