...
| Discord Bot | 5-2 | `appsettings.json` | Token, Guild ID, Npgsql DSN, chat bridge, rate limiting |
...
### Npgsql connection string format (for web servers and the Discord bot)
