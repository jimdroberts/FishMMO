...
namespace JamesFrowen.SimpleWeb
{
	public class SimpleWebServer
	{
		...
		public SimpleWebServer(int maxMessagesPerTick, TcpConfig tcpConfig, int maximumClients, int maxMessageSize, int handshakeMaxSize, SslConfig sslConfig, bool useProxyProtocol = false)
		{
			...
			server = new WebSocketServer(tcpConfig, maximumClients, maxMessageSize, handshakeMaxSize, sslConfig, bufferPool, useProxyProtocol);
		}
