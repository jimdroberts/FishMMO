...
namespace FishMMO.Shared
{
	...
	/// </summary>
	public abstract class FormulaTemplate<T, K> : ScriptableObject
	{
		/// <summary>
		/// Calculates the bonus value that <paramref name="bonus"/> contributes to <paramref name="self"/>.
		/// </summary>
		/// <param name="controller">The controller managing the calculation context.</param>
		...
		public abstract int CalculateBonus(T controller, K self, K bonus);
	}
}