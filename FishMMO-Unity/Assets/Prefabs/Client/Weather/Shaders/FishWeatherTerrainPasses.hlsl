...
// A copy of URP's TerrainLitPasses.hlsl, with the FishMMO edits marked below. URP offers no hook for this, so
// the file is copied. On a URP upgrade, diff it against
// Packages/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitPasses.hlsl and re-apply the edits.
#ifndef FISHMMO_WEATHER_TERRAIN_PASSES_INCLUDED
#define FISHMMO_WEATHER_TERRAIN_PASSES_INCLUDED
