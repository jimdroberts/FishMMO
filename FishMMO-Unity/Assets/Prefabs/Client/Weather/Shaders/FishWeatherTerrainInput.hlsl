// A copy of URP's TerrainLitInput.hlsl, with the FishMMO edits marked below. URP offers no hook for this, so
// the file is copied. On a URP upgrade, diff it against
// Packages/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitInput.hlsl and re-apply the edits.
#ifndef FISHMMO_WEATHER_TERRAIN_INPUT_INCLUDED
#define FISHMMO_WEATHER_TERRAIN_INPUT_INCLUDED
